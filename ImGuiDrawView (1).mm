...
- (void)drawInMTKView:(MTKView*)view
{
    ...
    io.DeltaTime = 0.5 / float(view.preferredFramesPerSecond ?: 90);
	...
	static int selectedTheme = 0;
            ...
            if (MenDeal == true)
            {
                ...
                ImGui::Begin("SHRINOWARE CODM 1.0.30", &MenDeal);
{
if (ImGui::BeginTabBar("##tabbarmain")) {
 if (ImGui::BeginTabItem("Main"))
{
        ImGui::Spacing();
        ImGui::Checkbox("Aim Assist", &show_aim); ImGui::SameLine(110);
        ImGui::Checkbox("Magic Bullet", &show_bullet);
        ImGui::Spacing();
        ImGui::Checkbox("Weapon Stability", &show_recoil); ImGui::SameLine(150);
        ImGui::Checkbox("No Spread", &show_spread);
        ImGui::Spacing();
...
{
      ImGui::Spacing();
      ImGui::Checkbox("NO GRASS", &show_L1); ImGui::SameLine(115);
      ImGui::Checkbox("NO FOG", &show_L2);
      ImGui::Spacing();
...
{
        ImGui::Spacing();
        ImGui::Checkbox("ESP - Name", &show_names); ImGui::SameLine(115);
	ImGui::Checkbox("ESP - Body", &show_body); ImGui::SameLine(215);
        ImGui::Checkbox("ESP - Map", &show_map);
        ImGui::Spacing();
...
if (ImGui::BeginTabItem("Potential Ban"))
{
      ImGui::Spacing();
      ImGui::Checkbox("Speedhack", &show_speed); ImGui::SameLine(105);
      ImGui::Checkbox("Long Slide", &show_slide); ImGui::SameLine(200);
      ImGui::Checkbox("Scope-in Fast", &show_scope);
      ImGui::Spacing();
...
{
   ImGui::Spacing();
   ImGui::RadioButton("ANTIBAN", &ban, 1); ImGui::SameLine();
   ImGui::Spacing();
		}
	}	
ImGui::EndTabBar();

ImGui::Text("Telegram: t.me/shrinoware\n© 2022. All rights reserved %.3f ms/frame (%.1f FPS)", 60.0f / ImGui::GetIO().Framerate, ImGui::GetIO().Framerate);
                }ImGui::End();
...
vm_writeData(0x1028D9D68, 0x028D9D68);   
vm_writeData(0x1028D9D68, 0xC0035FD6);

vm_writeData(0x1028D8D14, 0x028D9D68);
vm_writeData(0x1028D8D18, 0xC0035FD6);                           
...
vm_writeData(0x103294EB8, 0xC0035FD6);                                                         
vm_writeData(0x103294FB4, 0xC0035FD6);
vm_writeData(0x103295384, 0xC0035FD6);
vm_writeData(0x1032948E4, 0xC0035FD6);                                                         
vm_writeData(0x103294B70, 0xC0035FD6);
vm_writeData(0x103294DF8, 0xC0035FD6);
vm_writeData(0x103294CC8, 0xC0035FD6);                                                         
vm_writeData(0x103295724, 0xC0035FD6);
vm_writeData(0x1, 0xC0035FD6);
vm_writeData(0x1, 0xC0035FD6);                                                         
vm_writeData(0x1, 0xC0035FD6);
vm_writeData(0x1, 0xC0035FD6);
